...
const (
	RecommendService_RecommendProducts_FullMethodName = "/recommend.RecommendService/RecommendProducts"
)
...
func (c *recommendServiceClient) RecommendProducts(ctx context.Context, in *RecommendRequest, opts ...grpc.CallOption) (*RecommendResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(RecommendResponse)
	err := c.cc.Invoke(ctx, RecommendService_RecommendProducts_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type RecommendServiceServer interface {
	// 根据用户ID推荐商品列表
	RecommendProducts(context.Context, *RecommendRequest) (*RecommendResponse, error)
...
func (UnimplementedRecommendServiceServer) RecommendProducts(context.Context, *RecommendRequest) (*RecommendResponse, error) {
...
func _RecommendService_RecommendProducts_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(RecommendRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(RecommendServiceServer).RecommendProducts(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: RecommendService_RecommendProducts_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(RecommendServiceServer).RecommendProducts(ctx, req.(*RecommendRequest))
	}
	...
	Methods: []grpc.MethodDesc{
		{
			...
			Handler:    _RecommendService_RecommendProducts_Handler,
		},
	},
