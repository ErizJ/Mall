...
const (
	...
	ProductService_SearchSuggestions_FullMethodName = "/product.ProductService/SearchSuggestions"
...
func (c *productServiceClient) SearchSuggestions(ctx context.Context, in *SuggestionsRequest, opts ...grpc.CallOption) (*SuggestionsResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(SuggestionsResponse)
	err := c.cc.Invoke(ctx, ProductService_SearchSuggestions_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type ProductServiceServer interface {
	...
	// 搜索提示词（联想词）
	SearchSuggestions(context.Context, *SuggestionsRequest) (*SuggestionsResponse, error)
	// 搜索商品
...
func (UnimplementedProductServiceServer) SearchSuggestions(context.Context, *SuggestionsRequest) (*SuggestionsResponse, error) {
...
func _ProductService_SearchSuggestions_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(SuggestionsRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(ProductServiceServer).SearchSuggestions(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: ProductService_SearchSuggestions_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ProductServiceServer).SearchSuggestions(ctx, req.(*SuggestionsRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var ProductService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		},
		{
			...
			Handler:    _ProductService_SearchSuggestions_Handler,
		},
		{
